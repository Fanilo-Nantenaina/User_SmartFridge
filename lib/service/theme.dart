...
class ThemeSwitcher extends ChangeNotifier {
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    textTheme: const TextTheme(
      ...
      titleSmall: TextStyle(color: Color(0xFF64748B), fontWeight: FontWeight.w600),
      bodyLarge: TextStyle(color: Color(0xFF1E293B)),
      bodyMedium: TextStyle(color: Color(0xFF64748B)),
      bodySmall: TextStyle(color: Color(0xFF94A3B8)),
      labelLarge: TextStyle(color: Color(0xFF1E293B), fontWeight: FontWeight.w600),
      labelMedium: TextStyle(color: Color(0xFF64748B), fontWeight: FontWeight.w500),
  ...
  static ThemeData darkTheme = ThemeData(
      ...
      textTheme: const TextTheme(
        displayLarge: TextStyle(color: Color(0xFFF1F5F9), fontWeight: FontWeight.bold),
        displayMedium: TextStyle(color: Color(0xFFF1F5F9), fontWeight: FontWeight.bold),
        displaySmall: TextStyle(color: Color(0xFFF1F5F9), fontWeight: FontWeight.bold),
        ...
        titleSmall: TextStyle(color: Color(0xFF94A3B8), fontWeight: FontWeight.w600),
        ...
        labelMedium: TextStyle(color: Color(0xFF94A3B8), fontWeight: FontWeight.w500),
